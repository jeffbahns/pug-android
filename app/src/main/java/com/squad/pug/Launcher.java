...
//        setSupportActionBar(toolbar);
    ...
    public void onConnected(Bundle connectionHint){
        ...
        // Mock item model
        LocationData locationData = new LocationData(new LatLng(37.7743902, -122.4379349));
        GeometryData geometryData = new GeometryData(locationData);
        SearchItemModel mockItemModel =
                new SearchItemModel(geometryData, "http://maps.gstatic.com/mapfiles/place_api/icons/travel_agent-71.png",
                        "21a0b251c9b8392186142c798263e289fe45b4aa", "TEST ITEM", AppDefines.tempId);
        //ArrayList<String> mockString = getItemModelStringArray(mockItemModel);



        Intent intent = new Intent(this, MapsActivity.class);
        //intent.putStringArrayListExtra("Mock court", mockString);
